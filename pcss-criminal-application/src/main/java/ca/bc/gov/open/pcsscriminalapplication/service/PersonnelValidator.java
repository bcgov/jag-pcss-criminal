...
public interface PersonnelValidator {
    ...
    List<String> validateGetPersonnelAvailability(GetPersonnelAvailabilityRequest getPersonnelAvailabilityRequest);

    List<String> validateGetPersonnelAvailDetail(GetPersonnelAvailDetailRequest getPersonnelAvailDetailRequest);
