...
public class AppearanceController {
    ...
    @ResponsePayload
    public GetAppearanceCriminalResponse getAppearanceCriminal(
            @RequestPayload GetAppearanceCriminal getAppearanceCriminal)
        ...
        ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalRequest getAppearanceCriminalRequest =
                getAppearanceCriminal.getGetAppearanceCriminalRequest() != null
                                && getAppearanceCriminal
                                                .getGetAppearanceCriminalRequest()
                                                .getGetAppearanceCriminalRequest()
                                        != null
                        ? getAppearanceCriminal
                                .getGetAppearanceCriminalRequest()
        ...
        List<String> validation =
                appearanceValidator.validateGetAppearanceCriminal(getAppearanceCriminalRequest);
        ...
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(pcssProperties.getHost() + Keys.ORDS_APPEARANCE)
                        ...
                        .queryParam(
                                Keys.QUERY_HISTORY_FLAG,
                                getAppearanceCriminalRequest.getHistoryYN());
        ...
        try {
            ...
            GetAppearanceCriminalResponse getAppearanceCriminalResponse =
                    buildAppearanceResponse(response.getBody());
            ...
            log.error(
                    logBuilder.writeLogMessage(
                            ...
                            Keys.SOAP_METHOD_APPEARANCE,
                            getAppearanceCriminalRequest,
                            ex.getMessage()));
    ...
    private GetAppearanceCriminalResponse buildAppearanceResponse(
        ...
        GetAppearanceCriminalResponse2 getAppearanceCriminalResponse2 =
                new GetAppearanceCriminalResponse2();
        getAppearanceCriminalResponse2.setGetAppearanceCriminalResponse(
                getAppearanceCriminalResponseInner);
        getAppearanceCriminalResponse.setGetAppearanceCriminalResponse(
                getAppearanceCriminalResponse2);
    ...
    @PayloadRoot(
            ...
            localPart = Keys.SOAP_METHOD_APPEARANCE_APPR_METHOD)
    @ResponsePayload
    public GetAppearanceCriminalApprMethodResponse getAppearanceCriminalApprMethod(
            @RequestPayload GetAppearanceCriminalApprMethod getAppearanceCriminalApprMethod)
            throws JsonProcessingException {
        ...
        ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalApprMethodRequest
                getAppearanceCriminalApprMethodRequest =
                        getAppearanceCriminalApprMethod.getGetAppearanceCriminalApprMethodRequest()
                                                != null
                                        && getAppearanceCriminalApprMethod
                                                        .getGetAppearanceCriminalApprMethodRequest()
                                                        .getGetAppearanceCriminalApprMethodRequest()
                                                != null
                                ? getAppearanceCriminalApprMethod
                                        .getGetAppearanceCriminalApprMethodRequest()
        ...
        List<String> validation =
                appearanceValidator.validateGetAppearanceCriminalApprMethod(
                        getAppearanceCriminalApprMethodRequest);
        if (!validation.isEmpty()) {

            ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalApprMethodResponse
                    getAppearanceCriminalApprMethodResponse =
                            new ca.bc.gov.open.wsdl.pcss.one
                                    .GetAppearanceCriminalApprMethodResponse();

            getAppearanceCriminalApprMethodResponse.setResponseCd(
                    Keys.FAILED_VALIDATION.toString());
            getAppearanceCriminalApprMethodResponse.setResponseMessageTxt(
                    StringUtils.join(validation, ","));

            log.info(Keys.LOG_FAILED_VALIDATION, Keys.SOAP_METHOD_APPEARANCE);

            return buildAppearanceCriminalApprMethodResponse(
                    getAppearanceCriminalApprMethodResponse);
        }

        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(
                                pcssProperties.getHost() + Keys.ORDS_APPEARANCE_METHOD)
                        .queryParam(
                                Keys.QUERY_APPEARANCE_ID,
        ...
        try {
                    ...
                    response =
                            restTemplate.exchange(
                                    ...
                                    ca.bc.gov.open.wsdl.pcss.one
                                            .GetAppearanceCriminalApprMethodResponse.class);

            GetAppearanceCriminalApprMethodResponse getAppearanceCriminalApprMethodResponse =
                    buildAppearanceCriminalApprMethodResponse(response.getBody());
            ...
            log.error(
                    logBuilder.writeLogMessage(
                            Keys.ORDS_ERROR_MESSAGE,
                            Keys.SOAP_METHOD_APPEARANCE_APPR_METHOD,
                            getAppearanceCriminalApprMethodRequest,
                            ex.getMessage()));
            throw new ORDSException();
        }
    ...
    private GetAppearanceCriminalApprMethodResponse buildAppearanceCriminalApprMethodResponse(
            ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalApprMethodResponse
                    getAppearanceCriminalApprMethodResponseInner) {

        GetAppearanceCriminalApprMethodResponse getAppearanceCriminalApprMethodResponse =
                new GetAppearanceCriminalApprMethodResponse();
        GetAppearanceCriminalApprMethodResponse2 getAppearanceCriminalApprMethodResponse2 =
                new GetAppearanceCriminalApprMethodResponse2();
        getAppearanceCriminalApprMethodResponse2.setGetAppearanceCriminalApprMethodResponse(
                getAppearanceCriminalApprMethodResponseInner);
        getAppearanceCriminalApprMethodResponse.setGetAppearanceCriminalApprMethodResponse(
                getAppearanceCriminalApprMethodResponse2);
    ...
    @PayloadRoot(
            namespace = Keys.SOAP_NAMESPACE,
            localPart = Keys.SOAP_METHOD_APPEARANCE_APPR_METHOD_SECURE)
    @ResponsePayload
    public GetAppearanceCriminalApprMethodSecureResponse getAppearanceCriminalApprMethodSecure(
            @RequestPayload
                    GetAppearanceCriminalApprMethodSecure getAppearanceCriminalApprMethodSecure)
            throws JsonProcessingException {
        ...
        ca.bc.gov.open.wsdl.pcss.secure.one.GetAppearanceCriminalApprMethodSecureRequest
                getAppearanceCriminalApprMethodSecureRequest =
                        getAppearanceCriminalApprMethodSecure
                                                        .getGetAppearanceCriminalApprMethodSecureRequest()
                                                != null
                                        && getAppearanceCriminalApprMethodSecure
                                                        .getGetAppearanceCriminalApprMethodSecureRequest()
                                                        .getGetAppearanceCriminalApprMethodSecureRequest()
        ...
        List<String> validation =
                appearanceValidator.validateGetAppearanceCriminalApprMethodSecure(
                        getAppearanceCriminalApprMethodSecureRequest);
        if (!validation.isEmpty()) {

            ca.bc.gov.open.wsdl.pcss.secure.one.GetAppearanceCriminalApprMethodResponse
                    appearanceCriminalApprMethodResponse =
                            new ca.bc.gov.open.wsdl.pcss.secure.one
                                    .GetAppearanceCriminalApprMethodResponse();

            appearanceCriminalApprMethodResponse.setResponseCd(Keys.FAILED_VALIDATION.toString());
            appearanceCriminalApprMethodResponse.setResponseMessageTxt(
                    StringUtils.join(validation, ","));

            log.info(Keys.LOG_FAILED_VALIDATION, Keys.SOAP_METHOD_APPEARANCE);

            return buildAppearanceCriminalApprMethodSecureResponse(
                    appearanceCriminalApprMethodResponse);
        }

        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(
                                pcssProperties.getHost() + Keys.ORDS_APPEARANCE_METHOD_SECURE)
                        .queryParam(
                                Keys.QUERY_AGENT_ID,
                                getAppearanceCriminalApprMethodSecureRequest
                        ...
                        .queryParam(
                                ...
                                getAppearanceCriminalApprMethodSecureRequest.getApplicationCd())
                        .queryParam(
                                Keys.QUERY_APPEARANCE_ID,
        ...
        try {
            ...
            HttpEntity<ca.bc.gov.open.wsdl.pcss.secure.one.GetAppearanceCriminalApprMethodResponse>
                    response =
                            restTemplate.exchange(
                                    builder.build().toUri(),
                                    HttpMethod.GET,
            ...
            GetAppearanceCriminalApprMethodSecureResponse
                    getAppearanceCriminalApprMethodSecureResponse =
                            buildAppearanceCriminalApprMethodSecureResponse(response.getBody());
            ...
            log.error(
                    logBuilder.writeLogMessage(
                            Keys.ORDS_ERROR_MESSAGE,
                            Keys.SOAP_METHOD_APPEARANCE_APPR_METHOD_SECURE,
                            getAppearanceCriminalApprMethodSecureRequest,
                            ex.getMessage()));
            throw new ORDSException();
        }
    ...
    private GetAppearanceCriminalApprMethodSecureResponse
            buildAppearanceCriminalApprMethodSecureResponse(
                    ca.bc.gov.open.wsdl.pcss.secure.one.GetAppearanceCriminalApprMethodResponse
                            getAppearanceCriminalApprMethodResponseInner) {

        GetAppearanceCriminalApprMethodSecureResponse
                getAppearanceCriminalApprMethodSecureResponse =
                        new GetAppearanceCriminalApprMethodSecureResponse();
        ca.bc.gov.open.wsdl.pcss.secure.two.GetAppearanceCriminalApprMethodResponse
                getAppearanceCriminalApprMethodResponse2 =
                        new ca.bc.gov.open.wsdl.pcss.secure.two
                                .GetAppearanceCriminalApprMethodResponse();
        getAppearanceCriminalApprMethodResponse2.setGetAppearanceCriminalApprMethodResponse(
                getAppearanceCriminalApprMethodResponseInner);
        getAppearanceCriminalApprMethodSecureResponse.setGetAppearanceCriminalApprMethodResponse(
                getAppearanceCriminalApprMethodResponse2);
    ...
    @ResponsePayload
    public GetAppearanceCriminalCountResponse getAppearanceCriminalCount(
            @RequestPayload GetAppearanceCriminalCount getAppearanceCriminalCount)
            throws JsonProcessingException {
        ...
        ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalCountRequest
                getAppearanceCriminalCountRequest =
                        getAppearanceCriminalCount.getGetAppearanceCriminalCountRequest() != null
                                        && getAppearanceCriminalCount
                                                        .getGetAppearanceCriminalCountRequest()
                                                        .getGetAppearanceCriminalCountRequest()
                                                != null
                                ? getAppearanceCriminalCount
                                        .getGetAppearanceCriminalCountRequest()
        ...
        List<String> validation =
                appearanceValidator.validateGetAppearanceCriminalCount(
                        getAppearanceCriminalCountRequest);
        if (!validation.isEmpty()) {

            ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalCountResponse
                    getAppearanceCriminalCountResponse =
            ...
            getAppearanceCriminalCountResponse.setResponseMessageTxt(
                    StringUtils.join(validation, ","));
        ...
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(
                                pcssProperties.getHost() + Keys.ORDS_APPEARANCE_COUNT)
                        .queryParam(
                                Keys.QUERY_APPEARANCE_ID,
        ...
        try {
            ...
            GetAppearanceCriminalCountResponse getAppearanceCriminalCountResponse =
                    buildAppearanceCriminalCountResponse(response.getBody());
            ...
            log.error(
                    logBuilder.writeLogMessage(
                            Keys.ORDS_ERROR_MESSAGE,
                            Keys.SOAP_METHOD_APPEARANCE_COUNT,
                            getAppearanceCriminalCountRequest,
                            ex.getMessage()));
            throw new ORDSException();
        }
    ...
    private GetAppearanceCriminalCountResponse buildAppearanceCriminalCountResponse(
            ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalCountResponse
                    getAppearanceCriminalCountResponseInner) {

        GetAppearanceCriminalCountResponse getAppearanceCriminalCountResponse =
                new GetAppearanceCriminalCountResponse();
        ca.bc.gov.open.wsdl.pcss.two.GetAppearanceCriminalCountResponse2
                getAppearanceCriminalCountResponse2 =
                        new ca.bc.gov.open.wsdl.pcss.two.GetAppearanceCriminalCountResponse2();
        getAppearanceCriminalCountResponse2.setGetAppearanceCriminalCountResponse(
                getAppearanceCriminalCountResponseInner);
        getAppearanceCriminalCountResponse.setGetAppearanceCriminalCountResponse(
                getAppearanceCriminalCountResponse2);
    ...
    @PayloadRoot(
            namespace = Keys.SOAP_NAMESPACE,
            localPart = Keys.SOAP_METHOD_APPEARANCE_COUNT_SECURE)
    @ResponsePayload
    public GetAppearanceCriminalCountSecureResponse getAppearanceCriminalCountSecure(
            @RequestPayload GetAppearanceCriminalCountSecure getAppearanceCriminalCountSecure)
            throws JsonProcessingException {
        ...
        ca.bc.gov.open.wsdl.pcss.secure.one.GetAppearanceCriminalCountSecureRequest
                getAppearanceCriminalCountSecureRequest =
                        getAppearanceCriminalCountSecure
                                                        .getGetAppearanceCriminalCountSecureRequest()
                                                != null
                                        && getAppearanceCriminalCountSecure
                                                        .getGetAppearanceCriminalCountSecureRequest()
                                                        .getGetAppearanceCriminalCountSecureRequest()
        ...
        List<String> validation =
                appearanceValidator.validateGetAppearanceCriminalCountSecure(
                        getAppearanceCriminalCountSecureRequest);
        if (!validation.isEmpty()) {

            ca.bc.gov.open.wsdl.pcss.secure.one.GetAppearanceCriminalCountResponse
                    appearanceCriminalCountResponse =
                            new ca.bc.gov.open.wsdl.pcss.secure.one
                                    .GetAppearanceCriminalCountResponse();

            appearanceCriminalCountResponse.setResponseCd(Keys.FAILED_VALIDATION.toString());
            appearanceCriminalCountResponse.setResponseMessageTxt(
                    StringUtils.join(validation, ","));
        ...
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(
                                pcssProperties.getHost() + Keys.ORDS_APPEARANCE_COUNT_SECURE)
                        .queryParam(
                                Keys.QUERY_AGENT_ID,
                                getAppearanceCriminalCountSecureRequest
                                        .getRequestAgencyIdentifierId())
                        ...
                        .queryParam(
                                Keys.QUERY_APPLICATION_CD,
                                getAppearanceCriminalCountSecureRequest.getApplicationCd())
                        .queryParam(
                                Keys.QUERY_APPEARANCE_ID,
        ...
        try {
            ...
            HttpEntity<ca.bc.gov.open.wsdl.pcss.secure.one.GetAppearanceCriminalCountResponse>
                    response =
                            restTemplate.exchange(
                                    builder.build().toUri(),
                                    HttpMethod.GET,
                                    new HttpEntity<>(new HttpHeaders()),
                                    ca.bc.gov.open.wsdl.pcss.secure.one
                                            .GetAppearanceCriminalCountResponse.class);

            GetAppearanceCriminalCountSecureResponse getAppearanceCriminalCountSecureResponse =
                    buildAppearanceCriminalCountResponse(response.getBody());
            ...
            log.error(
                    logBuilder.writeLogMessage(
                            Keys.ORDS_ERROR_MESSAGE,
                            Keys.SOAP_METHOD_APPEARANCE_COUNT_SECURE,
                            getAppearanceCriminalCountSecureRequest,
                            ex.getMessage()));
            throw new ORDSException();
        }
    ...
    private GetAppearanceCriminalCountSecureResponse buildAppearanceCriminalCountResponse(
            ca.bc.gov.open.wsdl.pcss.secure.one.GetAppearanceCriminalCountResponse
                    getAppearanceCriminalCountResponseInner) {

        GetAppearanceCriminalCountSecureResponse getAppearanceCriminalCountSecureResponse =
                new GetAppearanceCriminalCountSecureResponse();
        ca.bc.gov.open.wsdl.pcss.secure.two.GetAppearanceCriminalCountResponse
                getAppearanceCriminalCountResponse2 =
                        new ca.bc.gov.open.wsdl.pcss.secure.two
                                .GetAppearanceCriminalCountResponse();
        getAppearanceCriminalCountResponse2.setGetAppearanceCriminalCountResponse(
                getAppearanceCriminalCountResponseInner);
        getAppearanceCriminalCountSecureResponse.setGetAppearanceCriminalCountResponse(
                getAppearanceCriminalCountResponse2);
    ...
    @ResponsePayload
    public GetAppearanceCriminalResourceResponse getAppearanceCriminalResource(
            @RequestPayload GetAppearanceCriminalResource getAppearanceCriminalResource)
            throws JsonProcessingException {
        ...
        ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalResourceRequest
                getAppearanceCriminalResourceRequest =
                        getAppearanceCriminalResource.getGetAppearanceCriminalResourceRequest()
                                                != null
                                        && getAppearanceCriminalResource
                                                        .getGetAppearanceCriminalResourceRequest()
                                                        .getGetAppearanceCriminalResourceRequest()
                                                != null
                                ? getAppearanceCriminalResource
                                        .getGetAppearanceCriminalResourceRequest()
        ...
        List<String> validation =
                appearanceValidator.validateGetAppearanceCriminalResource(
                        getAppearanceCriminalResourceRequest);
        if (!validation.isEmpty()) {

            ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalResourceResponse
                    getAppearanceCriminalResourceResponse =
                            new ca.bc.gov.open.wsdl.pcss.one
                                    .GetAppearanceCriminalResourceResponse();

            getAppearanceCriminalResourceResponse.setResponseCd(Keys.FAILED_VALIDATION.toString());
            getAppearanceCriminalResourceResponse.setResponseMessageTxt(
                    StringUtils.join(validation, ","));
        ...
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(
                                pcssProperties.getHost() + Keys.ORDS_APPEARANCE_RESOURCE)
                        .queryParam(
                                Keys.QUERY_APPEARANCE_ID,
        ...
        try {
            ...
            HttpEntity<ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalResourceResponse>
                    response =
                            restTemplate.exchange(
                                    ...
                                    new HttpEntity<>(new HttpHeaders()),
                                    ca.bc.gov.open.wsdl.pcss.one
                                            .GetAppearanceCriminalResourceResponse.class);

            GetAppearanceCriminalResourceResponse getAppearanceCriminalResourceResponse =
                    buildAppearanceCriminalResourceResponse(response.getBody());
            ...
            log.error(
                    logBuilder.writeLogMessage(
                            Keys.ORDS_ERROR_MESSAGE,
                            Keys.SOAP_METHOD_APPEARANCE_RESOURCE,
                            getAppearanceCriminalResourceRequest,
                            ex.getMessage()));
            throw new ORDSException();
        }
    ...
    private GetAppearanceCriminalResourceResponse buildAppearanceCriminalResourceResponse(
            ca.bc.gov.open.wsdl.pcss.one.GetAppearanceCriminalResourceResponse
        ...
        ca.bc.gov.open.wsdl.pcss.two.GetAppearanceCriminalResourceResponse2
                getAppearanceCriminalResourceResponse2 =
                        new ca.bc.gov.open.wsdl.pcss.two.GetAppearanceCriminalResourceResponse2();
        getAppearanceCriminalResourceResponse2.setGetAppearanceCriminalResourceResponse(
                getAppearanceCriminalResourceResponseInner);
        getAppearanceCriminalResourceResponse.setGetAppearanceCriminalResourceResponse(
                getAppearanceCriminalResourceResponse2);
    ...
    @ResponsePayload
    public GetAppearanceCriminalSecureResponse getAppearanceCriminalSecure(
            @RequestPayload GetAppearanceCriminalSecure getAppearanceCriminalSecure)
            throws JsonProcessingException {
        ...
        ca.bc.gov.open.wsdl.pcss.secure.one.GetAppearanceCriminalSecureRequest
                getAppearanceCriminalSecureRequest =
                        getAppearanceCriminalSecure.getGetAppearanceCriminalSecureRequest() != null
                                        && getAppearanceCriminalSecure
                                                        .getGetAppearanceCriminalSecureRequest()
                                                        .getGetAppearanceCriminalSecureRequest()
                                                != null
                                ? getAppearanceCriminalSecure
                                        .getGetAppearanceCriminalSecureRequest()
        ...
        List<String> validation =
                appearanceValidator.validateGetAppearanceCriminalSecure(
                        getAppearanceCriminalSecureRequest);
        if (!validation.isEmpty()) {
        ...
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(
                                pcssProperties.getHost() + Keys.ORDS_APPEARANCE_SECURE)
                        .queryParam(
                                Keys.QUERY_AGENT_ID,
                                getAppearanceCriminalSecureRequest.getRequestAgencyIdentifierId())
                        .queryParam(
                                Keys.QUERY_APPLICATION_CD,
                                getAppearanceCriminalSecureRequest.getApplicationCd())
                        .queryParam(
                                Keys.QUERY_PART_ID,
                        ...
                        .queryParam(
                                Keys.QUERY_JUSTIN_NO,
                                getAppearanceCriminalSecureRequest.getJustinNo())
                        .queryParam(
                                Keys.QUERY_FUTURE_FLAG,
                                getAppearanceCriminalSecureRequest.getFutureYN())
                        .queryParam(
                                Keys.QUERY_HISTORY_FLAG,
                                getAppearanceCriminalSecureRequest.getHistoryYN());
        ...
        try {
            ...
            GetAppearanceCriminalSecureResponse getAppearanceCriminalSecureResponse =
                    buildAppearanceCriminalSecureResponse(response.getBody());
            ...
            log.error(
                    logBuilder.writeLogMessage(
                            Keys.ORDS_ERROR_MESSAGE,
                            Keys.SOAP_METHOD_APPEARANCE_SECURE,
                            getAppearanceCriminalSecureRequest,
                            ex.getMessage()));
            throw new ORDSException();
        }
    ...
    private GetAppearanceCriminalSecureResponse buildAppearanceCriminalSecureResponse(
        ...
        ca.bc.gov.open.wsdl.pcss.secure.two.GetAppearanceCriminalResponse
                getAppearanceCriminalResponse2 =
                        new ca.bc.gov.open.wsdl.pcss.secure.two.GetAppearanceCriminalResponse();
        getAppearanceCriminalResponse2.setGetAppearanceCriminalResponse(
                getAppearanceCriminalResponseInner);
        getAppearanceCriminalSecureResponse.setGetAppearanceCriminalResponse(
                getAppearanceCriminalResponse2);
    ...
    @ResponsePayload
    public SetAppearanceCriminalResponse setAppearanceCriminal(
            @RequestPayload SetAppearanceCriminal setAppearanceCriminal)
            throws JsonProcessingException {

        log.info(Keys.LOG_RECEIVED, Keys.SOAP_METHOD_SET_APPEARANCE);

        ca.bc.gov.open.wsdl.pcss.one.SetAppearanceCriminalRequest setAppearanceCriminalRequest =
                setAppearanceCriminal.getSetAppearanceCriminalRequest() != null
                                && setAppearanceCriminal
                                                .getSetAppearanceCriminalRequest()
                                                .getSetAppearanceCriminalRequest()
                                        != null
                        ? setAppearanceCriminal
                                .getSetAppearanceCriminalRequest()
        ...
        List<String> validation =
                appearanceValidator.validateSetAppearanceCriminal(setAppearanceCriminalRequest);
        if (!validation.isEmpty()) {

            ca.bc.gov.open.wsdl.pcss.one.SetAppearanceCriminalResponse
                    setAppearanceCriminalResponse =
        ...
        try {
            ...
            SetAppearanceCriminalResponse setAppearanceCriminalResponse =
                    buildAppearanceCriminalResponse(response.getBody());
            ...
            log.error(
                    logBuilder.writeLogMessage(
                            Keys.ORDS_ERROR_MESSAGE,
                            Keys.SOAP_METHOD_SET_APPEARANCE,
    ...
    private SetAppearanceCriminalResponse buildAppearanceCriminalResponse(
            ca.bc.gov.open.wsdl.pcss.one.SetAppearanceCriminalResponse
                    setAppearanceCriminalResponseInner) {

        SetAppearanceCriminalResponse setAppearanceCriminalResponse =
                new SetAppearanceCriminalResponse();
        SetAppearanceCriminalResponse2 setAppearanceCriminalResponse2 =
                new SetAppearanceCriminalResponse2();
        setAppearanceCriminalResponse2.setSetAppearanceCriminalResponse(
                setAppearanceCriminalResponseInner);
        setAppearanceCriminalResponse.setSetAppearanceCriminalResponse(
                setAppearanceCriminalResponse2);
    ...
    @PayloadRoot(
            namespace = Keys.SOAP_NAMESPACE,
            localPart = Keys.SOAP_METHOD_SET_APPEARANCE_METHOD)
    @ResponsePayload
    public SetAppearanceMethodCriminalResponse setAppearanceMethodCriminal(
            @RequestPayload SetAppearanceMethodCriminal setAppearanceMethodCriminal)
            throws JsonProcessingException {
        ...
        ca.bc.gov.open.wsdl.pcss.one.SetAppearanceMethodCriminalRequest
                setAppearanceMethodCriminalRequest =
                        setAppearanceMethodCriminal.getSetAppearanceMethodCriminalRequest() != null
                                        && setAppearanceMethodCriminal
                                                        .getSetAppearanceMethodCriminalRequest()
                                                        .getSetAppearanceMethodCriminalRequest()
                                                != null
                                ? setAppearanceMethodCriminal
                                        .getSetAppearanceMethodCriminalRequest()
        ...
        List<String> validation =
                appearanceValidator.validateSetAppearanceMethodCriminal(
                        setAppearanceMethodCriminalRequest);
        if (!validation.isEmpty()) {

            ca.bc.gov.open.wsdl.pcss.one.SetAppearanceMethodCriminalResponse
                    setAppearanceMethodCriminalResponse =
            ...
            setAppearanceMethodCriminalResponse.setResponseMessageTxt(
                    StringUtils.join(validation, ","));
        ...
        try {
            ...
            SetAppearanceMethodCriminalResponse setAppearanceMethodCriminalResponse =
                    buildAppearanceMethodCriminalResponse(response.getBody());
            ...
            log.error(
                    logBuilder.writeLogMessage(
                            Keys.ORDS_ERROR_MESSAGE,
                            Keys.SOAP_METHOD_SET_APPEARANCE_METHOD,
                            setAppearanceMethodCriminalRequest,
                            ex.getMessage()));
            throw new ORDSException();
        }
    ...
    private SetAppearanceMethodCriminalResponse buildAppearanceMethodCriminalResponse(
            ca.bc.gov.open.wsdl.pcss.one.SetAppearanceMethodCriminalResponse
                    setAppearanceMethodCriminalResponseInner) {

        SetAppearanceMethodCriminalResponse setAppearanceMethodCriminalResponse =
                new SetAppearanceMethodCriminalResponse();
        SetAppearanceMethodCriminalResponse2 setAppearanceMethodCriminalResponse2 =
                new SetAppearanceMethodCriminalResponse2();
        setAppearanceMethodCriminalResponse2.setSetAppearanceMethodCriminalResponse(
                setAppearanceMethodCriminalResponseInner);
        setAppearanceMethodCriminalResponse.setSetAppearanceMethodCriminalResponse(
                setAppearanceMethodCriminalResponse2);
