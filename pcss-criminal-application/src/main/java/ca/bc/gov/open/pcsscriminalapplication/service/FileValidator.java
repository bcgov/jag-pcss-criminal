...
public interface FileValidator {
    ...
    List<String> validateGetFileDetailCriminal(GetFileDetailCriminalRequest getFileDetailCriminalRequest);

    List<String> validateGetFileDetailCriminalSecure(ca.bc.gov.open.wsdl.pcss.secure.one.GetFileDetailCriminalRequest getFileDetailCriminalRequest);
