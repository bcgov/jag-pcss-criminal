...
public class SetHearingRestrictionCriminalTest {
    ...
    public SetHearingRestrictionCriminal createTestRequest() {
        SetHearingRestrictionCriminal setHearingRestrictionCriminal = new SetHearingRestrictionCriminal();
        SetHearingRestrictionCriminalRequest setHearingRestrictionCriminalRequest = new SetHearingRestrictionCriminalRequest();
        ca.bc.gov.open.wsdl.pcss.one.SetHearingRestrictionCriminalRequest setHearingRestrictionCriminalRequest1 = new ca.bc.gov.open.wsdl.pcss.one.SetHearingRestrictionCriminalRequest();
        ...
        setHearingRestrictionCriminalRequest.setSetHearingRestrictionCriminalRequest(setHearingRestrictionCriminalRequest1);
        setHearingRestrictionCriminal.setSetHearingRestrictionCriminalRequest(setHearingRestrictionCriminalRequest);
