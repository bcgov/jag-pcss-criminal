...
public class ValidateGetAppearanceCriminalResourceTest {
    ...
    public void successTestReturns() {
        ...
        getAppearanceCriminalResourceRequest.setRequestDtm(Instant.now());
        ...
        List<String> result =
                sut.validateGetAppearanceCriminalResource(getAppearanceCriminalResourceRequest);
    ...
    public void failTestReturns() {
        ...
        getAppearanceCriminalResourceRequest.setRequestDtm(null);
